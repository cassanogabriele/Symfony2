...
class __TwigTemplate_a11be5949216c40be247f4cbf0be2b6afbfb02716a6a286f94d4945abc3ada5a extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(twig_to_array(["exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) ? $context["previous_count"] : $this->getContext($context, "previous_count"))]));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(twig_to_array(["logs" => $this->getAttribute((isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "logs", [])]));
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(twig_to_array(["exception" => (isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception"))]));
        // line 92
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/var/www/clients/client0/web2/web/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
